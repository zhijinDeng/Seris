...
required = [
    ...
    *[f"提交材料/{index:02d}_{name}.md" for index, name in enumerate([
    ...
    "docs/research-evidence-matrix.md", "docs/production-decision-assurance-contract.md",
    "data/quality_ontology.jsonld", "data/factory_events.csv", "data/quality_cases.json",
    ...
    "app/app.js", "app/dashboard.js", "app/assets/quality-agent.png", "scripts/run_quality_agent.py",
...
required_event_fields = {"event_time", "ingest_time", "source_system", "source_event_id", "sequence_no", "quality_code", "schema_version"}
...
interaction_ids = [
    ...
    "interventionResult", "resilienceOptions", "responsibilityMatrix",
]
...
print(f"材料检查通过: {len(required)} 个核心文件，{len(docx_files)} 个DOCX，4个可计算场景，13个关键交互节点。")
